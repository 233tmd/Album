...
import th.action.ToolPanelAction;
...
public class ViewerFrame extends JFrame {
	...
	public void init() {
		...
		this.setTitle("看图程序");
		// 设置大小
		//setPreferredSize:将组件的首选大小设置为常量,父类方法
	...
	public JPanel createToolPanel() {
		...
		// 工具数组
		String[] toolarr = { "th.action.OpenAction", 
				"th.action.LastAction", 
				"th.action.NextAction", 
				"th.action.BigAction", 
				"th.action.SmallAction" };
		
		for (int i = 0; i < toolarr.length; i++) {
			ToolPanelAction action = new ToolPanelAction(new ImageIcon("img/"
